 ...
 */
@PublicEvolving
public class CustomPurgingTrigger<T, W extends CustomWindow> extends Trigger<T, W> {
     ...
     */
    public static <T, W extends CustomWindow> CustomPurgingTrigger<T, W> of(Trigger<T, W> nestedTrigger) {
